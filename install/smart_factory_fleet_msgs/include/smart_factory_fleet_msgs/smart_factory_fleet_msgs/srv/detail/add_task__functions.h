...
#ifndef SMART_FACTORY_FLEET_MSGS__SRV__DETAIL__ADD_TASK__FUNCTIONS_H_
#define SMART_FACTORY_FLEET_MSGS__SRV__DETAIL__ADD_TASK__FUNCTIONS_H_
 ...
 * calls
 * smart_factory_fleet_msgs__srv__AddTask_Request__init().
...
/**
 * It calls
 * smart_factory_fleet_msgs__srv__AddTask_Request__fini()
 ...
 * smart_factory_fleet_msgs__srv__AddTask_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * smart_factory_fleet_msgs__srv__AddTask_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * smart_factory_fleet_msgs__srv__AddTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_smart_factory_fleet_msgs
...
/**
 * It calls
 * smart_factory_fleet_msgs__srv__AddTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_smart_factory_fleet_msgs
...
/**
 * It allocates the memory for the array and calls
 * smart_factory_fleet_msgs__srv__AddTask_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_smart_factory_fleet_msgs
...
/**
 * It calls
 * smart_factory_fleet_msgs__srv__AddTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SMART_FACTORY_FLEET_MSGS__SRV__DETAIL__ADD_TASK__FUNCTIONS_H_
